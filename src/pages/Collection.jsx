...
const Collection = () => {
  ...
  return (
<div className='flex flex-col sm:flex-row gap-6 pt-10 border-t min-h-[80vh] bg-white/90 rounded-xl shadow-md px-4 py-6'>
      ...
      <div className='min-w-60'>
        ...
        {/* Category Filter */}
        <div className={`border border-gray-200 bg-white rounded-lg shadow-sm p-5 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
  ...
  className='border border-gray-300 rounded-md px-3 py-1 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-300 transition'
>
